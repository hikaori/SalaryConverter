...
import static com.example.paulo.salaryconverter.R.mipmap.usa;
...
public class SalaryInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mcountryBank.add(new Country("United States", usa));
...
// SOUTH KOREA
        ...
        for (int a = 0; a < msalaryBank.size(); a++) {
            ...
            if (averageSalary.salaryJobName.getJobName().equals(job)) {
                if (averageSalary.slaryCountry.getCountryName().equals(home)) {
                    // SET AVERAGE SALARY TEXT
                    mHc_salary.setText(msalaryBank.get(a).getAverageSalary());
                }
                else if(averageSalary.slaryCountry.getCountryName().equals(remote)) {
                    // SET AVERAGE SALARY TEXT
